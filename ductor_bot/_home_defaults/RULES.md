...
This is the top-level `~/.jarvis` directory.
...
- `~/.jarvis/agents.json` is the single source of truth for all sub-agent
...
`~/.jarvis/SHAREDMEMORY.md` contains facts shared across all agents
